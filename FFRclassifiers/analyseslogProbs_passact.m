...
% arrange results
    ...
    for i=1:length(files)
      ...
      %The following commands were commented out to remove the separation
      %based on group (musicians vs non-musician) because here, we want
      %separation based on condition (passive vs active)
    ...
    %replaced the second element of the tab array with 'spclasses' or
    %'pnclasses'
    tab = [subids' spclasses' totsizes' plogpsid'];
    %tab = [subids' pnclasses' totsizes' plogpsid'];
